  ...
  function Edify(element){
    ...
    */
    ...
    function update(text) {
      ...
      pm.taskManager({task:'update', status:'done'});
    }
    ...
    function previewResult(){
      ...
      /*@Comment: pm.preview.innerHTML = pm.editing.value; replacing this with iFrame for acheiving scoping of js and css */
